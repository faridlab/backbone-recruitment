//! Domain policy for RequisitionSkill aggregate
//!
...
/// Domain policy for RequisitionSkill — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<RequisitionSkill>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type RequisitionSkillDomainPolicy = PermitAllPolicy<RequisitionSkill>;
