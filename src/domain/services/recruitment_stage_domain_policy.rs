//! Domain policy for RecruitmentStage aggregate
//!
...
/// Domain policy for RecruitmentStage — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<RecruitmentStage>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type RecruitmentStageDomainPolicy = PermitAllPolicy<RecruitmentStage>;
