//! Domain policy for Interview aggregate
//!
...
/// Domain policy for Interview — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<Interview>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type InterviewDomainPolicy = PermitAllPolicy<Interview>;
