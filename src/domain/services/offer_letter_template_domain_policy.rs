//! Domain policy for OfferLetterTemplate aggregate
//!
...
/// Domain policy for OfferLetterTemplate — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<OfferLetterTemplate>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type OfferLetterTemplateDomainPolicy = PermitAllPolicy<OfferLetterTemplate>;
