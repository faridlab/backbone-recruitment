//! Specifications for JobRequisition aggregate
//!
...
// Each predicate implements `Specification<JobRequisition>` and can be combined
...
//
// pub struct ActiveJobRequisitionSpec;
// impl Specification<JobRequisition> for ActiveJobRequisitionSpec {
//     fn is_satisfied_by(&self, e: &JobRequisition) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
