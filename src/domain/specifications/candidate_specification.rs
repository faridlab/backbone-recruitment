//! Specifications for Candidate aggregate
//!
...
// Each predicate implements `Specification<Candidate>` and can be combined
...
//
// pub struct ActiveCandidateSpec;
// impl Specification<Candidate> for ActiveCandidateSpec {
//     fn is_satisfied_by(&self, e: &Candidate) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
