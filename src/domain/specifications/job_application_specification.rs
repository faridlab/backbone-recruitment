//! Specifications for JobApplication aggregate
//!
...
// Each predicate implements `Specification<JobApplication>` and can be combined
...
//
// pub struct ActiveJobApplicationSpec;
// impl Specification<JobApplication> for ActiveJobApplicationSpec {
//     fn is_satisfied_by(&self, e: &JobApplication) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
